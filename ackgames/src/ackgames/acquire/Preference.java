...
public  class Preference
{
    public static String m_hotelStr[] = {"Luxor","Tower","American","WorldWide",
     ...
     public static Font PURCHASE_FONT =new Font("Serif", Font.BOLD, 14);
     ...
     public static int CHAT_LENGTH = 40;
     ...
     public static Color MERGE_TILE_BACKGROUND = new Color(50,140,50);
     public static Color MERGE_TILE_FOREGROUND = Color.black;
