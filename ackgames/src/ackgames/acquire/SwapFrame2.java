...
public class SwapFrame2 extends Frame
{
    int m_defunct;
    int m_survivor;
    String m_bonus;
	...
	public SwapFrame2(GameBoard gb)
	{
		...
		//{{INIT_CONTROLS
		setLayout(null);
		setBackground(new Color(120,173,237));
		setSize(530,214);
		setVisible(false);
		l1.setText("t2");
		add(l1);
		...
		m_ok.setLabel("OK");
		add(m_ok);
		m_ok.setBackground(Color.lightGray);
		m_ok.setBounds(420,144,60,24);
		m_sellAll.setLabel("Sell All");
		add(m_sellAll);
		m_sellAll.setBackground(Color.lightGray);
		m_sellAll.setBounds(420,180,60,24);
		add(keepChoice);
		keepChoice.setBackground(Color.white);
		...
		g2.setAlignment(Label.CENTER);
		panel1.add(g2);
		g2.setFont(new Font("SansSerif", Font.BOLD, 14));
		g2.setBounds(0,0,0,0);
		panel1.add(g3);
		g3.setBounds(0,0,0,0);
		g4.setAlignment(Label.CENTER);
		panel1.add(g4);
	...
	Choice swapChoice = new Choice();
	Label label3 = new Label();
	Choice sellChoice = new Choice();
	Button m_ok = new Button();
	Button m_sellAll = new Button();
	TextField keepChoice = new TextField();
