...
public class Acquire extends Applet {
    ...
    void initTiles() {
        ...
        gbc1.fill = gbc1.BOTH;
        gbc1.weightx=3;
        m_leftTop.setBackground(new Color(195,175,145));
        ...
        m_acquireLabel.setForeground(Color.white);
        m_acquireLabel.setFont(new Font("Serif", Font.ITALIC, 36));
        m_fill2Panel.setBackground(new Color(172,213,255));
        m_fill1Panel.setBackground(new Color(172,213,255));
        ...
        lobbyPanel.setBackground(new Color(79,148,233));
        ...
        sePanel.setBackground(new Color(79,148,233));
    ...
    void  updateTiles()
    {
        ...
        for ( int t = 0; t< 6; t++) {
            ...
            switch(an.getType())
            {
                ...
                case Tile.MERGE:
                    traceError3("MERGE");
                    b.setBackground(Preference.MERGE_TILE_BACKGROUND);
                    b.setForeground(Preference.MERGE_TILE_FOREGROUND);
                    break;
                default:
    ...
    void playTile( Tile ti) {

        for (int i = 0; i < 6; i++){
            if(m_GUIStats.m_tileButton[i].getLabel().equals(ti.getLabel())){
                playTile(m_GUIStats.m_tileButton[i]);
            }
        }
    }
    ...
    class MyTextActionListener implements ActionListener
   {
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (text.length() >Preference.CHAT_LENGTH){
                text = text.substring(0,Preference.CHAT_LENGTH)+"...";
            }
